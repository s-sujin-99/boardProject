        ...
        <div class="notion-callout-block error">
            ...
            <div class="notion-callout-content">
                <div class="notion-error-title">
                    <c:choose>
                        <c:when test="${mode eq 'update'}">게시글 수정에 실패하였습니다.</c:when>
                        <c:when test="${mode eq 'delete'}">게시글 삭제에 실패하였습니다.</c:when>
                        <c:when test="${mode eq 'select'}">게시글을 불러오는 데 실패하였습니다.</c:when>
        ...
        <div class="notion-btn-group">
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <a href="/board/list" class="notion-back-link">📁 목록으로 돌아가기</a>
                </c:otherwise>
            </c:choose>
        </div>
