...
<body>
	<h2>상품 등록</h2>
	<%-- 1. enctype 뒤의 둥근 따옴표(”)를 표준 쌍따옴표(")로 수정하고, id="item"을 명시했습니다. --%>
	<form:form id="item" modelAttribute="item" action="/item2/insert" method ="post"
	...
	<div>
		...
		<button type="button" id="btnRegister">upload</button>
